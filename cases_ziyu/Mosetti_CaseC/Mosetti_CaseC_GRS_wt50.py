...
# 读取CSV文件
df = pd.read_csv(home_path+'/solvers/floris/cases_ziyu/Mosetti_CaseC/Mosetti_CaseC_wind_rose.csv')
...
#     os.path.join(home_path, "solvers/floris/cases_ziyu/Mosetti_CaseC/Mosetti_CaseC_wind_rose.csv"), wd_col="wd", ws_col="ws", freq_col="freq_val", ti_col_or_value=0.075
# )

# Load the Floris model
fmodel = FlorisModel(os.path.join(home_path, "solvers/floris/cases_ziyu/inputs/Mosetti_CaseC.yaml"))
D = 126.
