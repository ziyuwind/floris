...
from floris.user_defined.user_defined_rotor_velocity import (
    average_velocity,
...
@define
class UserDefinedTurbine(BaseOperationModel):
    """
    ...
    def power(
        ...
        **_ # <- Allows other models to accept other keyword arguments
        ...
        # No need for yaw correction and tilt correction.
        ...
        # Compute power
        power = cosd(yaw_angles)**power_thrust_table["pP"]*power_interpolator(rotor_effective_velocities) * 1e3 # Convert to W
    ...
    def thrust_coefficient(
        ...
        **_ # <- Allows other models to accept other keyword arguments
        ...
        thrust_coefficient = (
            thrust_coefficient
            * cosd(yaw_angles)**power_thrust_table['pT']
            * ( cosd(tilt_angles - power_thrust_table["ref_tilt"]) )**power_thrust_table['pT']
        )
    ...
    def axial_induction(
        ...
        **_ # <- Allows other models to accept other keyword arguments
        ...
        thrust_coefficient = UserDefinedTurbine.thrust_coefficient(
